...
INSERT INTO users (username, "password", email, role, organization_name, created_at) VALUES
   ...
   ('johndoe10300', 'emp123',           'johndoe10300@proton.me', 'EMPLOYEE', 'ACME Corp', NOW());
...
(
   ...
   (1, 'Ana',      'Marin',   '2860505123456', 'manager01', 'manager@acme.com', 'Str. Libertatii 10', 'Bucuresti', 'RO'),
   -- angajatii
   (2, 'John',     'Doe',     '1900301123457', 'john.doe',  'john.doe@acme.com', 'Str. Lalelelor 5',   'Cluj-Napoca', 'RO'),
   (3, 'Jane',     'Smith',   '2910623123458', 'jane.smith','jane.smith@acme.com', 'Bd. Unirii 15',      'Iasi',        'RO'),
   (4, 'Maria',    'Pop',     '2930915123459', 'maria.pop', 'maria.pop@acme.com', 'Calea Victoriei 88', 'București',  'RO'),
   (5, 'Alex',     'Ionescu', '1941201123460', 'alex.iones','alex.iones@acme.com', 'Str. Pacii 42',      'Timisoara',  'RO'),
   (6, 'John', 'Doe', '5030301123461', 'johndoe10300', 'johndoe10300@proton.me', 'Str. Castanilor 12', 'Brașov', 'RO')
